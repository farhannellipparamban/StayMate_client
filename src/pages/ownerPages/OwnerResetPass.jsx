...
import { ownerResetPassword } from "../../api/ownerApi";
...
const OwnerResetPass = () => {
  ...
  const onSubmit = async () => {
    try {
      setLoading(true);
      const res = await ownerResetPassword(id, token, values.password);
      if (res.status === 200) {
