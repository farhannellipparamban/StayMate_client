        ...
        <div className=" px-6 py-12 mx-auto">
          <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/2 lg:mx-6">
              ...
              <div className="mt-6 space-y-8 md:mt-8 font-serif">
                <p className="flex items-start -mx-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6 mx-2 text-red-600 dark:text-red-500"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
                  ...
                  <span className="mx-2 text-black truncate w-72 dark:text-black font-bold">
                    Manjeri,Malappuram 676303. Kerala
                  </span>
                </p>
                <p className="flex items-start -mx-2">
                  <svg
                  ...
                  <span className="mx-2 text-blacktruncate w-72 dark:text-black font-bold">
                    (+91)9645106751
                  </span>
                </p>
                <p className="flex items-start -mx-2">
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6 font-serif">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
                ...
                <form className="mt-6">
                  ...
                  <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-50">
                    get in touch
                  </button>
                </form>
              </div>
